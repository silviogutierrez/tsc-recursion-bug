...
export const routeFactory = <TGlobalHooks, Unused>(
    hooks: (props: JoySpecificGlobalHooksUtilities<unknown>) => TGlobalHooks | false,
) => <
...
>(options: {
    ...
    >(options: {
        ...
        const wrappedResolve = async (props: {
            ...
            const innerResolver =
                options.resolve ?? (() => Promise.resolve({} as TInnerResolve));
    ...
    const bindHooksGuardAndTabs = <TProps, TAllGuards>() => <
    ...
    >(
        ...
        >(
            ...
            return {
                tabNames,
                ...bindHooksGuardAndTabs<TProps, TInclusiveGuardedProps>()(
                    tabNames,
                    tabDefinitions,
                    hooks,
                ),
        ...
        const withIndex = (
            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const {withTab: unused, ...everythingElse} = chainedWithTab;
    ...
    function withHooks<THooks>(
        hooks: (
            props: {
                ...
                resolved: TResolve;
                params: ExtractRouteParams<TPath>;
            } & JoySpecificUtilities<TResolve, TTabs, ExtractRouteParams<TPath>> &
                TGlobalHooks,
        ) => THooks,
    ) {
        const {withTab, withIndex, withConditions} = bindHooksGuardAndTabs<
            THooks,
            never
        >()([], {}, hooks);
...
export const createRouter = <TRoutes extends Array<RouteDefinition<string, any, any>>>(
    routes: [...TRoutes],
) => {
...
const castParams = (
    ...
    uncastedParams: Record<typeof definition["processed"]["tokens"][number][0], string>,
) => {
